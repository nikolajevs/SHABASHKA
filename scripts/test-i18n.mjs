...
for(const [page,title,count] of [['terms','Умови використання',7],['privacy','Політика конфіденційності',9],['cookies','Cookie та налаштування',2]]) {
